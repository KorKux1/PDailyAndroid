    ...
    public void onReceive(Context context, Intent intent) {
        ...
        switch (type) {
            case "FOOD01":
                ...
                NotificationFollowUp breakfast = new NotificationFollowUp(UUID.randomUUID().toString(), "¿Ya desayunaste?", date);
            ...
            case "FOOD02":
                ...
                NotificationFollowUp lunch = new NotificationFollowUp(UUID.randomUUID().toString(), "¿Ya almorzaste?", date);
            ...
            case "FOOD03":
                ...
                NotificationFollowUp dinner = new NotificationFollowUp(UUID.randomUUID().toString(), "¿Ya cenaste?", date);
            ...
            case "LEVO":
                ...
                NotificationFollowUp levo = new NotificationFollowUp(UUID.randomUUID().toString(), "¿Ya tomaste tu medicina?", date);
